...
class wwAuthImportExport_Admin_EnterpriseWebApp extends EnterpriseWebApp 
{
	/** 
	...
	public function getTitle()
		{ return 'Authentication Maintenance'; }
	...
	{	
		...
		$htmlBody .= "
			<form action='../../config/plugins/wwAuthImportExport/webapps/import_authentications.php?import=1' method='POST' enctype='multipart/form-data'>
		...
		$htmlBody .= '</tr></table>';
		$htmlBody .= "<br><iframe id='framy' border=0 width=800px height=800px src='../../config/plugins/wwAuthImportExport/webapps/list_authentications.php'/>";
